...
export default class AccountService {
  ...
  async createAccount({ indexToRestore, inputData }: { indexToRestore?: number, inputData?: Array<any> | string }): Promise<void> {
    ...
    const accounts = await this.keyManagerService.getAccount(inputData, index, network, true);

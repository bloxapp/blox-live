...
export default class ReinstallProcess extends ProcessClass {
  ...
  constructor({ inputData = null }) {
    ...
    this.actions = [
      ...
      { instance: this.accountServiceTmp, method: 'recoverAccounts', params: { inputData } },
      { instance: this.keyVaultServiceTmp, method: 'updateVaultMountsStorage' },
      { instance: this.walletServiceTmp, method: 'syncVaultWithBlox', params: { isNew: false, processName: 'reinstall', isSeedless: typeof inputData === 'string'} },
